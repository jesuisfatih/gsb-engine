...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'admin-catalog': RouteRecordInfo<'admin-catalog', '/admin/catalog', Record<never, never>, Record<never, never>>,
    'admin-templates': RouteRecordInfo<'admin-templates', '/admin/templates', Record<never, never>, Record<never, never>>,
    ...
    'merchant-operations': RouteRecordInfo<'merchant-operations', '/merchant/operations', Record<never, never>, Record<never, never>>,
    'merchant-overview': RouteRecordInfo<'merchant-overview', '/merchant/overview', Record<never, never>, Record<never, never>>,
    'merchant-pricing': RouteRecordInfo<'merchant-pricing', '/merchant/pricing', Record<never, never>, Record<never, never>>,
    'merchant-shortcodes': RouteRecordInfo<'merchant-shortcodes', '/merchant/shortcodes', Record<never, never>, Record<never, never>>,
    'merchant-templates': RouteRecordInfo<'merchant-templates', '/merchant/templates', Record<never, never>, Record<never, never>>,
    ...
    'shopify-embedded': RouteRecordInfo<'shopify-embedded', '/shopify/embedded', Record<never, never>, Record<never, never>>,
    'shopify-embedded-analytics': RouteRecordInfo<'shopify-embedded-analytics', '/shopify/embedded/analytics', Record<never, never>, Record<never, never>>,
    'shopify-embedded-appearance': RouteRecordInfo<'shopify-embedded-appearance', '/shopify/embedded/appearance', Record<never, never>, Record<never, never>>,
    'shopify-embedded-audit': RouteRecordInfo<'shopify-embedded-audit', '/shopify/embedded/audit', Record<never, never>, Record<never, never>>,
    'shopify-embedded-bootstrap': RouteRecordInfo<'shopify-embedded-bootstrap', '/shopify/embedded/bootstrap', Record<never, never>, Record<never, never>>,
    'shopify-embedded-builder': RouteRecordInfo<'shopify-embedded-builder', '/shopify/embedded/builder', Record<never, never>, Record<never, never>>,
    'shopify-embedded-catalog': RouteRecordInfo<'shopify-embedded-catalog', '/shopify/embedded/catalog', Record<never, never>, Record<never, never>>,
    'shopify-embedded-dashboard': RouteRecordInfo<'shopify-embedded-dashboard', '/shopify/embedded/dashboard', Record<never, never>, Record<never, never>>,
    'shopify-embedded-designs': RouteRecordInfo<'shopify-embedded-designs', '/shopify/embedded/designs', Record<never, never>, Record<never, never>>,
    'shopify-embedded-editor-settings': RouteRecordInfo<'shopify-embedded-editor-settings', '/shopify/embedded/editor-settings', Record<never, never>, Record<never, never>>,
    'shopify-embedded-fonts': RouteRecordInfo<'shopify-embedded-fonts', '/shopify/embedded/fonts', Record<never, never>, Record<never, never>>,
    'shopify-embedded-gallery-images': RouteRecordInfo<'shopify-embedded-gallery-images', '/shopify/embedded/gallery-images', Record<never, never>, Record<never, never>>,
    'shopify-embedded-gang-sheet': RouteRecordInfo<'shopify-embedded-gang-sheet', '/shopify/embedded/gang-sheet', Record<never, never>, Record<never, never>>,
    'shopify-embedded-general': RouteRecordInfo<'shopify-embedded-general', '/shopify/embedded/general', Record<never, never>, Record<never, never>>,
    'shopify-embedded-image-to-sheet': RouteRecordInfo<'shopify-embedded-image-to-sheet', '/shopify/embedded/image-to-sheet', Record<never, never>, Record<never, never>>,
    'shopify-embedded-operations': RouteRecordInfo<'shopify-embedded-operations', '/shopify/embedded/operations', Record<never, never>, Record<never, never>>,
    'shopify-embedded-orders': RouteRecordInfo<'shopify-embedded-orders', '/shopify/embedded/orders', Record<never, never>, Record<never, never>>,
    'shopify-embedded-pricing': RouteRecordInfo<'shopify-embedded-pricing', '/shopify/embedded/pricing', Record<never, never>, Record<never, never>>,
    'shopify-embedded-print-on-demand': RouteRecordInfo<'shopify-embedded-print-on-demand', '/shopify/embedded/print-on-demand', Record<never, never>, Record<never, never>>,
    'shopify-embedded-print-techniques': RouteRecordInfo<'shopify-embedded-print-techniques', '/shopify/embedded/print-techniques', Record<never, never>, Record<never, never>>,
    'shopify-embedded-products': RouteRecordInfo<'shopify-embedded-products', '/shopify/embedded/products', Record<never, never>, Record<never, never>>,
    'shopify-embedded-setup': RouteRecordInfo<'shopify-embedded-setup', '/shopify/embedded/setup', Record<never, never>, Record<never, never>>,
    'shopify-embedded-shortcodes': RouteRecordInfo<'shopify-embedded-shortcodes', '/shopify/embedded/shortcodes', Record<never, never>, Record<never, never>>,
    'shopify-embedded-supplier-routing': RouteRecordInfo<'shopify-embedded-supplier-routing', '/shopify/embedded/supplier-routing', Record<never, never>, Record<never, never>>,
    'shopify-embedded-support': RouteRecordInfo<'shopify-embedded-support', '/shopify/embedded/support', Record<never, never>, Record<never, never>>,
    'shopify-embedded-team': RouteRecordInfo<'shopify-embedded-team', '/shopify/embedded/team', Record<never, never>, Record<never, never>>,
    'shopify-embedded-templates': RouteRecordInfo<'shopify-embedded-templates', '/shopify/embedded/templates', Record<never, never>, Record<never, never>>,
    'shopify-embedded-transactions': RouteRecordInfo<'shopify-embedded-transactions', '/shopify/embedded/transactions', Record<never, never>, Record<never, never>>,
    'shopify-embedded-webhooks': RouteRecordInfo<'shopify-embedded-webhooks', '/shopify/embedded/webhooks', Record<never, never>, Record<never, never>>,
    'shopify-embedded-welcome': RouteRecordInfo<'shopify-embedded-welcome', '/shopify/embedded/welcome', Record<never, never>, Record<never, never>>,
    'staff-workbench': RouteRecordInfo<'staff-workbench', '/staff/workbench', Record<never, never>, Record<never, never>>,
    'super-admin-overview': RouteRecordInfo<'super-admin-overview', '/super-admin/overview', Record<never, never>, Record<never, never>>,
